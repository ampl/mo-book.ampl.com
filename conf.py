...
copyright = '2022'
exclude_patterns = ['**.ipynb_checkpoints', '**.pytest_cache', '.DS_Store', 'Thumbs.db', '_build', 'tools']
...
html_theme_options = {'search_bar_text': 'Search this book...', 'launch_buttons': {'notebook_interface': 'classic', 'binderhub_url': '', 'jupyterhub_url': '', 'thebe': False, 'colab_url': 'https://colab.research.google.com'}, 'path_to_docs': '', 'repository_url': 'https://github.com/fdabrandao/MO-book-with-AMPL', 'repository_branch': 'dev', 'extra_footer': '', 'home_page_in_toc': True, 'announcement': '', 'analytics': {'google_analytics_id': ''}, 'use_repository_button': True, 'use_edit_page_button': False, 'use_issues_button': True}
